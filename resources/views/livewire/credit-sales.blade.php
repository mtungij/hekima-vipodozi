    ...
    <section>
        <div class="sm:px-6 lg:px-4 space-y-6">
            ...
            <div class="md__table_wrapper" wire:lazy>
                            ...
                            <tr wire:key="{{ $order->id }}" class="md__tr">
                                ...
                                <td class="md__td">
                                    <div class="flex items-center gap-3">
                                        <a title="pay debt" 
                                           href="{{ route('credit-sales.view', $order->id)}}"
                                           class="md__action_navigate"
                                           wire:navigate
                                        >
                                            <x-heroicon-o-paper-airplane class="size-4 text-white hover:fill-current" />
                                            <span>Pay</span>
                                        </a>
                                    </div>
                                </td>
                ...
                @empty($orders->items())
                <x-empty>{{__('No credit sales found!')}}</x-empty>
                @endempty
            </div>
            <div class="my-2">
                {{ $orders->links()}}
