...
<nav x-data="{ open: false }" class="sticky top-0 z-40 print:hidden w-full bg-gray-100 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-14">
            <div class="flex items-center gap-2">
                ...
                <!-- Navigation Links -->
                <div class="md:hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="false" class="text-xl text-orange-400" wire:navigate>
                        {{ __('Mauzodata') }}
                    </x-nav-link>
                </div>
            </div>
