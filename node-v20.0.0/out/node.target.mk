...
quiet_cmd__var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot = ACTION _var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot $@
cmd__var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj)/gen; "$(builddir)/node_mksnapshot" "$(obj)/gen/node_snapshot.cc"
...
$(obj)/gen/node_snapshot.cc: $(builddir)/node_mksnapshot FORCE_DO_CMD
	$(call do_cmd,_var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot)

all_deps += $(obj)/gen/node_snapshot.cc
action__var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot_outputs := $(obj)/gen/node_snapshot.cc

### Rules for action "reset_openssl_cnf":
quiet_cmd__var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf = ACTION _var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf $@
cmd__var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(builddir)/obj.target/deps/openssl; /usr/bin/python3.10 tools/copyfile.py ./deps/openssl/nodejs-openssl.cnf "$(builddir)/obj.target/deps/openssl/openssl.cnf"
...
$(builddir)/obj.target/deps/openssl/openssl.cnf: $(srcdir)/deps/openssl/nodejs-openssl.cnf FORCE_DO_CMD
	$(call do_cmd,_var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf)

all_deps += $(builddir)/obj.target/deps/openssl/openssl.cnf
action__var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf_outputs := $(builddir)/obj.target/deps/openssl/openssl.cnf
...
$(builddir)/node: | $(action__var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot_outputs) $(action__var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf_outputs)

# Preserve order dependency of special output on deps.
$(action__var_www_html_node_v20_0_0_node_gyp_node_target_node_mksnapshot_outputs) $(action__var_www_html_node_v20_0_0_node_gyp_node_target_reset_openssl_cnf_outputs): | $(obj).target/deps/histogram/libhistogram.a $(obj).target/deps/uvwasi/libuvwasi.a $(obj).target/libnode.a $(builddir)/node_mksnapshot $(obj).target/libnode_text_start.a $(obj).target/tools/v8_gypfiles/libv8_snapshot.a $(obj).target/tools/v8_gypfiles/libv8_libplatform.a $(obj).target/tools/icu/libicui18n.a $(obj).target/tools/icu/icuuc.stamp $(obj).target/deps/zlib/libzlib.a $(obj).target/deps/llhttp/libllhttp.a $(obj).target/deps/cares/libcares.a $(obj).target/deps/uv/libuv.a $(obj).target/deps/nghttp2/libnghttp2.a $(obj).target/deps/brotli/libbrotli.a $(obj).target/deps/openssl/libopenssl.a $(builddir)/openssl-cli $(obj).target/deps/ngtcp2/libngtcp2.a $(obj).target/deps/ngtcp2/libnghttp3.a $(obj).target/deps/base64/libbase64.a $(obj).target/deps/base64/libbase64_ssse3.a $(obj).target/deps/base64/libbase64_sse41.a $(obj).target/deps/base64/libbase64_sse42.a $(obj).target/deps/base64/libbase64_avx.a $(obj).target/deps/base64/libbase64_avx2.a $(obj).target/deps/googletest/gtest_prod.stamp $(obj).target/deps/simdutf/libsimdutf.a $(obj).target/deps/ada/libada.a $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/icu/libicuucx.a $(obj).target/tools/icu/icu_implementation.stamp $(obj).target/tools/icu/icu_uconfig.stamp $(obj).target/tools/icu/icu_uconfig_target.stamp $(obj).target/tools/icu/libicudata.a $(obj).target/tools/v8_gypfiles/libv8_base_without_compiler.a $(obj).target/tools/v8_gypfiles/torque_generated_definitions.stamp $(obj).target/tools/v8_gypfiles/v8_internal_headers.stamp $(obj).target/tools/v8_gypfiles/torque_runtime_support.stamp $(obj).target/tools/v8_gypfiles/v8_flags.stamp $(obj).target/tools/v8_gypfiles/libv8_libbase.a $(obj).target/tools/v8_gypfiles/v8_headers.stamp $(obj).target/tools/v8_gypfiles/v8_config_headers.stamp $(obj).target/tools/v8_gypfiles/v8_heap_base_headers.stamp $(obj).target/tools/v8_gypfiles/v8_version.stamp $(obj).target/tools/v8_gypfiles/v8_shared_internal_headers.stamp $(obj).target/tools/v8_gypfiles/v8_bigint.stamp $(obj).target/tools/v8_gypfiles/v8_heap_base.stamp $(obj).target/tools/v8_gypfiles/cppgc_base.stamp $(obj).target/tools/v8_gypfiles/libv8_zlib.a $(obj).target/tools/v8_gypfiles/run_gen-regexp-special-case.stamp $(obj).target/tools/v8_gypfiles/postmortem-metadata.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp $(obj).target/tools/v8_gypfiles/libv8_compiler.a $(obj).target/tools/v8_gypfiles/libv8_turboshaft.a $(obj).target/tools/v8_gypfiles/v8_compiler_sources.stamp $(obj).target/tools/v8_gypfiles/libv8_initializers.a $(obj).target/tools/v8_gypfiles/torque_generated_initializers.stamp $(obj).target/deps/zlib/libzlib_inflate_chunk_simd.a $(obj).target/deps/zlib/libzlib_adler32_simd.a $(obj).target/deps/zlib/libzlib_crc32_simd.a
