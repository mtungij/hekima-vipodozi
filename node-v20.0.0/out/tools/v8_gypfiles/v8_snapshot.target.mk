...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S: 0e08e9413bd18aa6ed48df5fa1bcc6a1fc1da087.intermediate
	@:
.INTERMEDIATE: 0e08e9413bd18aa6ed48df5fa1bcc6a1fc1da087.intermediate
0e08e9413bd18aa6ed48df5fa1bcc6a1fc1da087.intermediate: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,touch)
	$(call do_cmd,_var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
action__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
...
$(OBJS): | $(action__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
