...
quiet_cmd__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action = ACTION _var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action $@
cmd__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/v8_gypfiles; mkdir -p $(obj)/gen/generate-bytecode-output-root/builtins-generated; /usr/bin/python3.10 ../../deps/v8/tools/run.py "$(builddir)/bytecode_builtins_list_generator" "$(obj)/gen/generate-bytecode-output-root/builtins-generated/bytecodes-builtins-list.h"
...
$(obj)/gen/generate-bytecode-output-root/builtins-generated/bytecodes-builtins-list.h: $(builddir)/bytecode_builtins_list_generator FORCE_DO_CMD
	$(call do_cmd,_var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action)

all_deps += $(obj)/gen/generate-bytecode-output-root/builtins-generated/bytecodes-builtins-list.h
action__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action_outputs := $(obj)/gen/generate-bytecode-output-root/builtins-generated/bytecodes-builtins-list.h


### Rules for final target.
# Build our special outputs first.
$(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp: | $(action__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action_outputs)

# Preserve order dependency of special output on deps.
$(action__var_www_html_node_v20_0_0_tools_v8_gypfiles_v8_gyp_generate_bytecode_builtins_list_target_generate_bytecode_builtins_list_action_outputs): | $(builddir)/bytecode_builtins_list_generator
